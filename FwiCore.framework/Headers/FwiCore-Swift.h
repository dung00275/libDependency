...
#ifndef FWICORE_SWIFT_H
#define FWICORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FwiCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7FwiCore28PluggableApplicationDelegate")
...
- (void)applicationSignificantTimeChange:(UIApplication * _Nonnull)application;
...
- (void)application:(UIApplication * _Nonnull)application performFetchWithCompletionHandler:(void (^ _Nonnull)(UIBackgroundFetchResult))completionHandler SWIFT_AVAILABILITY(tvos,introduced=11.0) SWIFT_AVAILABILITY(ios,introduced=7.0);
...
- (void)applicationProtectedDataWillBecomeUnavailable:(UIApplication * _Nonnull)application;
- (void)applicationProtectedDataDidBecomeAvailable:(UIApplication * _Nonnull)application;
...
- (UIViewController * _Nullable)application:(UIApplication * _Nonnull)application viewControllerWithRestorationIdentifierPath:(NSArray<NSString *> * _Nonnull)identifierComponents coder:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
- (BOOL)application:(UIApplication * _Nonnull)application shouldSaveApplicationState:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
- (BOOL)application:(UIApplication * _Nonnull)application shouldRestoreApplicationState:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
- (void)application:(UIApplication * _Nonnull)application willEncodeRestorableStateWithCoder:(NSCoder * _Nonnull)coder;
- (void)application:(UIApplication * _Nonnull)application didDecodeRestorableStateWithCoder:(NSCoder * _Nonnull)coder;
...
- (void)application:(UIApplication * _Nonnull)application willChangeStatusBarOrientation:(UIInterfaceOrientation)newStatusBarOrientation duration:(NSTimeInterval)duration;
...
- (void)application:(UIApplication * _Nonnull)application willChangeStatusBarFrame:(CGRect)newStatusBarFrame;
- (void)application:(UIApplication * _Nonnull)application didChangeStatusBarFrame:(CGRect)oldStatusBarFrame;
- (void)application:(UIApplication * _Nonnull)application didRegisterUserNotificationSettings:(UIUserNotificationSettings * _Nonnull)notificationSettings SWIFT_AVAILABILITY(ios,introduced=8.0,deprecated=10.0,message="Use UserNotifications Framework's -[UNUserNotificationCenter requestAuthorizationWithOptions:completionHandler:]");
...
SWIFT_AVAILABILITY(tvos,introduced=10.0) SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface PluggableApplicationDelegate (SWIFT_EXTENSION(FwiCore))
...
@interface UIAlertController (SWIFT_EXTENSION(FwiCore))
...
@interface UINavigationController (SWIFT_EXTENSION(FwiCore))
...
@interface UISplitViewController (SWIFT_EXTENSION(FwiCore))
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@property (nonatomic, readonly) BOOL shouldAutorotate;
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
...
@interface UITabBarController (SWIFT_EXTENSION(FwiCore))
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@property (nonatomic, readonly) BOOL shouldAutorotate;
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
...
@interface UIView (SWIFT_EXTENSION(FwiCore))
